...
object tpd extends Trees.Instance[Type] with TypedTreeInfo {
  ...
  override val deepCpy: TypedTreeDeepCopier =
    new TypedTreeDeepCopier

  val cpyBetweenPhases = new TimeTravellingTreeCopier

  class TypedTreeDeepCopier extends TypedTreeCopier {
    override val alwaysCopy = true
    override val untpdCpy = untpd.deepCpy
  }

  class TypedTreeCopier extends TreeCopier {
    val untpdCpy = untpd.cpy
